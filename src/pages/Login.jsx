            ...
            <form className="space-y-4 md:space-y-6" action="#">
              <div>
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  className="bg-gray-50 py-2 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                  required=""
                />
              </div>
              <div>
                <label
                  htmlFor="password"
                  className="block mb-2 outline-none text-base font-medium text-gray-900 dark:text-white"
                >
                  Password
                </label>
                <input
                  ...
                  name="password"
                  id="password"
                  className="bg-gray-50 outline-none py-2 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                  required=""
                />
              </div>
              <button
                type="submit"
                className="w-full text-xl outline-none text-white bg-blue-600 hover:bg-blue-700 focus:outline-none font-medium rounded-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Login
              </button>
            </form>
